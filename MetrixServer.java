...
public class MetrixServer {
  ...
  public void run() throws IOException {
    ...
    try {
      ...
      metrixLogger.log.log(Level.SEVERE, "[ERROR] Reading properties file. {0}", Ex.toString());
      System.exit(1);
    }
    ...
    try {
      ...
      metrixLogger.log.log(Level.INFO, "Initializing Directory Watcher Service with directory: {0}", runDir);
