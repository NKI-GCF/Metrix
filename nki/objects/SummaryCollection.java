...
public class SummaryCollection implements Serializable {
  ...
  public String getSummaryCollectionXMLAsString(Command com) {
    ...
    try {
      ...
      metrixLogger.log.log(Level.SEVERE, "TransformerConfigurationException: {0}", TCE.toString());
    }
    catch (TransformerException TE) {
      metrixLogger.log.log(Level.SEVERE, "TransformerException: {0}", TE.toString());
    }
